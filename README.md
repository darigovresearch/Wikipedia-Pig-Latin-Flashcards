# Wikipedia-Pig-Latin-Flashcards
...
1. The front of every card has "(Wikipedia article on Pig Latin)" appended to the end so that if you have any other words in your collection, the Wikipedia definition will still be added when importing it.
2. Any updates or corrections to the deck will be available at <a href="https://github.com/darigovresearch/Wikipedia-Pig-Latin-Flashcards">https://github.com/darigovresearch/Wikipedia-Pig-Latin-Flashcards</a> so do return periodically to check if you have the latest version.
